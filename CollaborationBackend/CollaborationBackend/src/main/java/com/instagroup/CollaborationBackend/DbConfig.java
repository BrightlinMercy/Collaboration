package com.instagroup.CollaborationBackend;
...
public class DbConfig {
	@Bean
		...
		{	
			...
			basicDataSource.setUrl("jdbc:h2:tcp://localhost/~/instagroup");
		...
		LocalSessionFactoryBean localSessionFactoryBean()
		{
			...
			localSessionFactoryBean.setPackagesToScan("com.instagroup.CollaborationBackend.model");
